...
class CAR(Platforms):
  ...
  VOLKSWAGEN_CADDY_MK3 = VolkswagenPQPlatformConfig(
    ...
    VolkswagenCarSpecs(mass=1613, wheelbase=2.682, minSteerSpeed=0),
    chassis_codes={"2K"},
    wmis={WMI.VOLKSWAGEN_COMMERCIAL_BUS_VAN},
  )
  VOLKSWAGEN_CADDY_MAXI_MK3 = VolkswagenPQPlatformConfig(
    [
      VWCarDocs("Volkswagen Caddy Maxi 2019"),
    ],
    VolkswagenCarSpecs(mass=1877, wheelbase=3.006, minSteerSpeed=0),
    chassis_codes={"2K"},
    wmis={WMI.VOLKSWAGEN_COMMERCIAL_BUS_VAN},
  )
  ...
  VOLKSWAGEN_JETTA_MK6 = VolkswagenPQPlatformConfig(
    ...
    VolkswagenCarSpecs(mass=1518, wheelbase=2.65, minSteerSpeed=0, minEnableSpeed=20 * CV.KPH_TO_MS),
    chassis_codes={"5K", "AJ"},
  ...
  VOLKSWAGEN_PASSAT_NMS = VolkswagenPQPlatformConfig(
    ...
    VolkswagenCarSpecs(mass=1503, wheelbase=2.80, minSteerSpeed=0, minEnableSpeed=20 * CV.KPH_TO_MS),
    chassis_codes={"A3"},
  ...
  VOLKSWAGEN_SHARAN_MK2 = VolkswagenPQPlatformConfig(
    ...
    VolkswagenCarSpecs(mass=1639, wheelbase=2.92, minSteerSpeed=0),
    chassis_codes={"7N"},
    wmis={WMI.VOLKSWAGEN_EUROPE_CAR},
  )
