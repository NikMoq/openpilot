...
struct CameraInfo {
  type       @0 :Text;      # "stationary", "mobile", "tripod", "avtodoria"
  distance   @1 :Float32;   # meters to camera
  speedLimit @2 :Float32;   # km/h, 0 if unknown
  confidence @3 :Float32;   # 0.0-1.0
  isGroup    @4 :Bool;      # true for avtodoria (cascade)
  groupPos   @5 :UInt8;     # position in cascade (1-based)
  groupTotal @6 :UInt8;     # total cameras in cascade
}
...
struct MapdOut @0xa4f1eb3323f5f582 {
  ...
  nextCamera @24 :CameraInfo;  # <-- NEW: nearest camera ahead
}
